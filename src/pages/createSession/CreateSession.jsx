import { Copy, Film, ListVideo, Tv, Users } from "lucide-react";
...
const CreateSession = () => {
  ...
  const getContentTypeIcon = () => {
    ...
    if (categoryLower.includes("filme"))
      return <Film size={20} className="text-amber-400" />;
    if (categoryLower.includes("série"))
      return <Tv size={20} className="text-emerald-400" />;
    if (categoryLower.includes("anime"))
      return <Tv2 size={20} className="text-purple-400" />;
    if (categoryLower.includes("documentário"))
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-black text-gray-300">
      <Sidebar />
      <main className="flex-grow md:ml-20 p-4 sm:p-6 md:p-8 transition-all duration-300 ease-in-out flex items-center justify-center md:mt-0 mt-16">
          ...
          <div className="p-6 sm:p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 mt-2">
                Configure os detalhes para sua watch party!
              </p>
            </div>
              ...
              {isSeries && (
                <div className="animate-fadeIn">
                  ...
                  <input
                    ...
                    value={episodes}
                    onChange={(e) =>
                      setEpisodes(Math.max(1, parseInt(e.target.value) || 1))
                    }
            ...
            {sessionCode && (
              <div className="mt-8 p-4 bg-gradient-to-br from-sky-800/50 to-sky-900/70 border border-sky-700 rounded-lg text-center animate-fadeIn">
                ...
                <div className="flex items-center justify-center space-x-2 bg-black/30 p-3 rounded-md">
                  <p className="text-2xl font-mono tracking-wider text-white select-all">
                    {sessionCode}
                  </p>
                  <button
                ...
                <p className="text-xs text-gray-400 mt-3">
                  Compartilhe este código com seus amigos para que eles possam
                  entrar.
                </p>
              </div>
            )}
